...
def main(args):
    ...
    # print("quarantine_perc", quarantine_perc)
    # exit()
    ...
    print("Check best_params_dir: " + args.best_params_dir) 
    ...
    # task 2 modification: increase INITIAL_R_0 by 20% 
    # params_dict['INITIAL_R_0'] = params_dict['INITIAL_R_0'] * 1.2 

    # task 3: increase the opening date by 10 days 
    # params_dict['REOPEN_SHIFT_DAYS'] = 10

    # task 3: decrease the opening date by 10 days 
    # params_dict['REOPEN_SHIFT_DAYS'] = -10

    # task 4. social distances start day earlier by 2/4/7/10 days 
    # params_dict['INFLECTION_DAY'] = datetime.date(2020,3,18) # original
    # params_dict['INFLECTION_DAY'] = datetime.date(2020,3,8) 
    ...
    region_model.skip_vaccinations = args.skip_vaccinations 
    region_model.wrap_model = False 
    ...
    if args.save_csv_fname:
        ...
        combined_arr = np.vstack((dates_str, infections, hospitalizations, deaths,
            region_model.effective_r_arr, region_model.R_0_ARR, region_model.r_immunity_perc_arr, 
            region_model.total_immune_proportion_arr, region_model.perc_population_infected_thus_far_arr,
            region_model.vaccinated_proportion_arr, region_model.ifr_arr)).T
        headers = 'dates,infections,hospitalizations,deaths,mean_r_t' + \
                ',R_0_ARR,r_immunity_perc' + \
                ',total_immune_proportion,perc_population_infected_thus_far,vaccinated_proportion' + \
                ',ifr_arr'
...
if __name__ == '__main__':
    ...
    # vaccinations 
    parser.add_argument('--skip_vaccinations', action='store_true',
        help=('Skip the incorporation of vaccinations.'))
